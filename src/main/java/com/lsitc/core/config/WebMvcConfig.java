...
import com.lsitc.core.interceptor.ControllerLoggingInterceptor;
...
//    private AuthChkInterceptor authChkInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        // 로깅 인터셉터
        registry.addInterceptor(controllerLoggingInterceptor).excludePathPatterns("/login**").excludePathPatterns("/comm/login")
