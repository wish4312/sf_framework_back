...
public class MenuSearchListGetResponseVO {
  ...
  @Builder
  private MenuSearchListGetResponseVO(String menuId, String menuNm, String upMenuId, String url,
  ...
  public static MenuSearchListGetResponseVO of(MenuEntity menuEntity) {
    return builder()
